...
var firstPerson = 'Nazmul'; // Replace with the actual name
var firstLocation = 'Dhaka, Bangladesh'; // Replace with the actual location

var secondPerson = 'Sulochana'; // Replace with the actual name
var secondLocation = 'Mahendranagar, Nepal';
...
var timeLeaveStamp = new Date(2022, 10, 06);

//first day of renewed contact (year, month, day)
var timeMeetStamp = new Date(2028, 10, 06);
